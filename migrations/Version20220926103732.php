 ...
 */
final class Version20220926103732 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personne ADD profil_id INT DEFAULT NULL, ADD job_id INT DEFAULT NULL, DROP job');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personne ADD job VARCHAR(50) DEFAULT NULL, DROP profil_id, DROP job_id');
    }
}
